async function getResponce() {
    ...
    //let responce = await fetch("https://semtassta.github.io/bowp_semenova/technical_writer_portfolio/data/portfolio.json")
    let responce = await fetch("./data/portfolio.json")
